...
class StatisticsTab:
    ...
    def statistics_root(self):
        ...
        #self.statistics_dates.calendar.place(x = 0 , y = 0)   
        #self.statistics_dates.calendar.bind("<<CalendarSelected>>", lambda e: StatisticsTab.test_calendar(self , e))
        ...
        self.calendar_from.insert(0 , datetime.now())
        ...
        self.calendar_to.insert(0g , datetime.now())
