...
class StatisticsTab:
    ...
    def statistics_root(self):
        ...
        self.all_time = BooleanVar()

        self.statistics_type = StringVar()
        ...
        company = LoadInfo.employees_list(True)
        
        self.statistics_employee.current(newindex = company.index("Company"))
        ...
        self.statistics_dates_all = CTkCheckBox(self.date_all_frame , text = '' , bg_color='transparent' , width = 18 , command = lambda : StatisticsValues.switch_dates_all(self))
