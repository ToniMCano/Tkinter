...
class Main:
    def __init__(self, root):
        ...
        self.info.grid(row =0 , column = 0  , sticky = N+S)     
        ...
        self.frame_empresa.grid(row =0 , column = 1 , pady = 0 ,columnspan=2, sticky=W+E )
        ...
        self.label_nombre_empreasa.grid(row = 1 , column = 0, sticky=W , padx = 10 , pady = 2)
        ...
        self.entry_nombre_empresa.grid(row = 2, column= 0 , columnspan=2 , padx = 10  , sticky = W , pady = 2)
        ...
        self.entry_empleados_empresa.grid(row = 2 , column = 1 , padx = 10  , pady = 2)
        ...
        self.frame_contacto.grid(row = 1 , column = 1 ,padx = 5 , pady = 2 , columnspan=2 , sticky=W+E )
